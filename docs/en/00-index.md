...
- [Shape API](./01-shape-api.md) - Detailed guide to object shapes, derived helpers, unknown-key modes, and object-level rules.
- [Metadata And Introspection](./02-metadata-and-introspection.md) - Detailed guide to `meta(...)`, `describe(...)`, shape descriptors, and custom validator descriptors.
